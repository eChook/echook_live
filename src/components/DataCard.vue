...
<template>
  <div
    class="flex-shrink-0 min-w-32 p-3 bg-neutral-800 rounded-lg border border-neutral-700 shadow flex flex-col items-center justify-center space-y-1">
    ...
    <span class="text-2xl font-mono text-white font-bold">{{ displayValue }}</span>
  </div>
</template>
