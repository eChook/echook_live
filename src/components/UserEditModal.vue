            ...
            <div class="fixed inset-0 overflow-y-auto">
                <div class="flex min-h-full items-center justify-center p-4 text-center">
                    <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
                        ...
                        <DialogPanel
                            class="w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-neutral-800 border border-zinc-200 dark:border-neutral-700 p-6 text-left align-middle shadow-xl transition-all">
                            <DialogTitle as="h3" class="text-lg font-medium leading-6 text-zinc-900 dark:text-white mb-4">
                                Edit User
                            </DialogTitle>
                            ...
                            <div class="mt-2 space-y-4">
                                ...
                                <!-- Team -->
                                <div>
                                    <label class="block text-xs font-bold uppercase text-zinc-500 dark:text-gray-500 mb-1">Team</label>
                                ...
                                <!-- Number -->
                                <div>
                                    <label class="block text-xs font-bold uppercase text-zinc-500 dark:text-gray-500 mb-1">Number</label>
                                ...
                                <SwitchGroup>
                                    <div class="flex items-center space-x-3">
                                        <Switch v-model="form.isAdmin"
                                            :class="form.isAdmin ? 'bg-primary' : 'bg-zinc-300 dark:bg-neutral-700'"
                                        ...
                                        <SwitchLabel class="text-sm font-medium text-zinc-700 dark:text-gray-300 cursor-pointer">Is Admin
                                        </SwitchLabel>
                                    </div>
                                </SwitchGroup>
                            ...
                            <div class="mt-6 flex justify-end space-x-3">
                                <button type="button"
                                    class="inline-flex justify-center rounded-md border border-zinc-300 dark:border-neutral-600 bg-transparent px-4 py-2 text-sm font-medium text-zinc-700 dark:text-gray-300 hover:bg-zinc-100 dark:hover:bg-neutral-700 focus:outline-none"
                                    @click="closeModal">
                                    Cancel
                                </button>
                                <button type="button"
                                    class="inline-flex justify-center rounded-md border border-transparent bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-primary/80 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-neutral-800"
                                    @click="save">
                                    Save Changes
                                </button>
                            </div>
