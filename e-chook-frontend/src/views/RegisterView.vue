    ...
    <div class="w-full max-w-md p-8 bg-neutral-800 rounded-xl shadow-2xl border border-neutral-700">
      ...
      <form @submit.prevent="handleRegister" class="space-y-4">
        <div>
          ...
          <input v-model="formData.car" type="text" required class="w-full bg-neutral-900 border border-neutral-600 rounded-lg p-3 text-white focus:border-primary outline-none transition">
        </div>
        <div>
          <label class="block mb-1 text-sm font-medium text-gray-400">Team Name</label>
          <input v-model="formData.team" type="text" required class="w-full bg-neutral-900 border border-neutral-600 rounded-lg p-3 text-white focus:border-primary outline-none transition">
        </div>
        <div>
          <label class="block mb-1 text-sm font-medium text-gray-400">Password</label>
          <input v-model="formData.password" type="password" required class="w-full bg-neutral-900 border border-neutral-600 rounded-lg p-3 text-white focus:border-primary outline-none transition">
        </div>
        <div>
          ...
          <input 
            ...
            type="password" 
            required 
            class="w-full bg-neutral-900 border rounded-lg p-3 text-white outline-none transition"
            :class="{
